...
(() => {
 ...
 function fit(){
  ...
  const availableHeight=area.clientHeight-parseFloat(a.paddingTop)-parseFloat(a.paddingBottom)-top.offsetHeight-document.getElementById('play-tip').offsetHeight-12-frame;
 ...
 const observer=new ResizeObserver(schedule);observer.observe(area);observer.observe(document.getElementById('play-tip'));
